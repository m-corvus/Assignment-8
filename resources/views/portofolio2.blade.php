...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="#" class="nav__logo">Rifqi</a>
    ...
    <main class="main">
            ...
            <div class="home__container container grid">
                <div class="home__content grid">
                    ...
                    <div class="home__data">
                        <h1 class="home__title">Hi, I'am Rifqi!</h1>
                ...
                <div class="qualification__sections">
                    ...
                    <div class="qualification__content qualification__active" data-content id="education">
                        <div class="qualification__data">
                            <!-- ====== Qualifications 1 ====== -->
                            <div>
                                <h3 class="qualification__data">Sistem Informasi</h3>
                                <span class="qualification__subtitle">Gunadarma University</span>
                        ...
                        <div class="qualification__data">
                            ...
                            <div>
                                <h3 class="qualification__data">Backend Developer</h3>
                                <span class="qualification__subtitle">Hactive8 Bootcamp</span>
                                <div class="qualification__calendar">
                                    <i class="uil uil-calendar-alt"></i>
                                    Aug 2021 - Sept 2021
                                </div>
                        ...
                        <div class="qualification__data">
                            <div>
                                <h3 class="qualification__data">Teknik Komputer Jaringan</h3>
                                <span class="qualification__subtitle">SMKN 1 Kota Bekasi</span>
                                <div class="qualification__calendar">
                                    <i class="uil uil-calendar-alt"></i>
                                    2015 - 2018
                                </div>
                    ...
                    <div class="qualification__content" data-content id="work">
                        ...
                        <div class="qualification__data">
                            ...
                            <div>
                                <h3 class="qualification__data">Backend Developer</h3>
                                <span class="qualification__subtitle">Hactive8</span>
                                <div class="qualification__calendar">
                                    <i class="uil uil-calendar-alt"></i>
                                    Oct 2021 - Des 2021
                                </div>
                        ...
                        <div class="qualification__data">
                            <div>
                                <h3 class="qualification__data">Intern Backend Developer Jr</h3>
                                <span class="qualification__subtitle">Omnitech Meta Kreasi</span>
                                <div class="qualification__calendar">
                                    <i class="uil uil-calendar-alt"></i>
                                    Feb 2021 - Apr 2021
                                </div>
                        ...
                        <div class="qualification__data">
                            ...
                            <div>
                                <h3 class="qualification__data">Intern Techinal Support</h3>
                                <span class="qualification__subtitle">Andalas Media Informatika</span>
                                <div class="qualification__calendar">
                                    <i class="uil uil-calendar-alt"></i>
                                    Jan 2017 - Mar 2017
                                </div>
                        ...
                        <div class="services__modal-content">
                            ...
                            <ul class="services__modal-services grid">
                                <li class="services__modal-service">
                                    ...
                                    <p>I develop backend website</p>
                                </li>
                                <li class="services__modal-service">
                                    <i class="uil uil-check-circle services__modal-icon"></i>
                                    <p>Creating Content Management System</p>
                                </li>
                                <li class="services__modal-service">
                                    <i class="uil uil-check-circle services__modal-icon"></i>
                                    <p>Easy managed your company data</p>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <section class="portofolio section" id="portofolio">
            ...
            <div class="portofolio__container container swiper-container">
                <div class="swiper-wrapper">
                    <!-- ======== Portofolio 1 ======= -->
                    <div class="portofolio__content grid swiper-slide">
                        <img src="assets/img/portfolio1.jpg" alt="" class="portofolio__img">

                        <div class="portofolio__data">
                            <h3 class="portofolio__title">Modern Website</h3>
                            <p class="portofolio__description">
                    ...
                    <!-- ======== Portofolio 2 ======= -->
                    <div class="portofolio__content grid swiper-slide">
                        <img src="assets/img/portfolio3.jpg" alt="" class="portofolio__img">
            ...
            <div class="project__bg">
                <div class="project__container container grid">
                    <div class="project__data">
                        <h2 class="project__title">You have a new poject</h2>
                        <p class="project__description">
                            Contact me now and let's build your dream apps
                        </p>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="testimonial__content swiper-slide">
                        ...
                        <p class="testimonial__description">
                            I get good impression, I carry out my project
                            with all the pssible quality and attention and
                    ...
                    <div class="testimonial__content swiper-slide">
                        <div class="testimonial__data">
                            <div class="testimonial__header">
                                ...
                                <div>
                                    <h3 class="testimonial__name">Matt Shadow</h3>
                                    <span class="testimonial__client">Client</span>
                                </div>
                            </div>
                    ...
                    <div class="testimonial__content swiper-slide">
                        <div class="testimonial__data">
                            <div class="testimonial__header">
                                ...
                                <div>
                                    <h3 class="testimonial__name">Jimmy Hendrix</h3>
                                    <span class="testimonial__client">Client</span>
                                </div>
                            </div>
            ...
            <div class="contact__container container grid">
                <div>
                    <div class="contact__information">
                        ...
                        <div>
                            ...
                            <span class="contact__subtitle">082111768038</span>
                        </div>
                    </div>
                    ...
                    <div class="contact__information">
                        ...
                        <div>
                            ...
                            <span class="contact__subtitle">hallo@akmalrifqi.id</span>
                        </div>
                    </div>
                    ...
                    <div class="contact__information">
                        ...
                        <div>
                            ...
                            <span class="contact__subtitle">Indonesia - Bekasi</span>
                        </div>
                    </div>
                </div>
                ...
                <form action="" class="contact__form grid">
                    ...
                    <div class="contact__content">
                        ...
                        <textarea type="text" cols="0" rows="7" class="contact__input"></textarea>
                    </div>
        ...
        <footer class="footer">
            <div class="footer__bg">
                <div class="footer__container container grid">
                    <div>
                        <h1 class="footer__title">Rifqi</h1>
                    ...
                    <ul class="footer__links">
                        ...
                        <li>
                            <a href="#portofolio" class="footer__link">Portofolio</a>
                        </li>
                        <li>
                    ...
                    <div class="footer__socials">
                        ...
                        <a href="https://linkedin.com" target="_blank" class="footer__social">
                            <i class="uil uil-linkedin-alt"></i>
                        </a>
                    </div>
                </div>

                <p class="footer__copy">&#169; akmalrifqi.id. All right reserved</p>
            </div>
        </footer> --}}
